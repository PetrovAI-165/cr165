package kursa;
import javax.swing.*;
public class SignInFrameS extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            boolean u=si.signInSystem(l,p);
            if(u){
                this.setVisible(false);
                Student1Frame s1f = new Student1Frame();
                s1f.setVisible(true);
            }else{
            JOptionPane.showMessageDialog(null, "Пользователь с таким паролем отсутствует", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignInFrameS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignInFrameS().setVisible(true);
            }
        });
    }
