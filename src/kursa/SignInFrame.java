...
public class SignInFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(9, 211, 9));
        ...
        jRadioButton2.setText("ПРЕПОДАВАТЕЛЬ");

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("ВЫ ЖЕЛАЕТЕ ВОЙТИ КАК:");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kursa/student.png"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kursa/professor3.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if (jRadioButton1.isSelected())
        ...
        SignInFrameS sis = new SignInFrameS();
        sis.setVisible(true);
        }else{
        this.setVisible(false);
        SignInFrameT sit = new SignInFrameT();
        sit.setVisible(true);
       }
